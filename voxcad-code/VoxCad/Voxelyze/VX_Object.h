...
public:
	...
	// static inline bool CVXC_Structure::is_base64(unsigned char c) {return (isalnum(c) || (c == '+') || (c == '/'));} (nac: changed to below)
	...
	// inline int GetIndex(int x, int y, int z) const; //returns the index of the array from xyz indices
...
public:
	...
	// ElectricallyActive:
	int SetNeuralSensorType(int _NeuralSensorType) {NeuralSensorType = _NeuralSensorType;}
	int SetNeuralActivatedMuscleType(int _NeuralActivatedMuscleType) {NeuralActivatedMuscleType = _NeuralActivatedMuscleType;}
	void SetIsGroundTouchSensor(bool _IsGroundTouchSensor) {IsGroundTouchSensor = _IsGroundTouchSensor;}
	void SetIsPacemaker(bool isPace) {IsPacemaker = isPace;}
	void SetIsConductive(bool isCond) {IsConductive = isCond;}
	void SetRepolarizationTime(float _RepolarizationTime) {RepolarizationTime = _RepolarizationTime;}
	void SetDepolarizationTime(float _DepolarizationTime) {DepolarizationTime = _DepolarizationTime;}
	...
	// ElectricallyActive:
	inline int GetNeuralSensorType(void) const {return NeuralSensorType;}
	inline int GetNeuralActivatedMuscleType(void) const {return NeuralActivatedMuscleType;}
	inline bool GetIsGroundTouchSensor(void) const {return IsGroundTouchSensor;}
	inline bool GetIsPacemaker(void) const {return IsPacemaker;}
	inline bool GetIsConductive(void) const {return IsConductive;}
	inline float GetRepolarizationTime(void) const {return RepolarizationTime;}
	inline float GetDepolarizationTime(void) const {return DepolarizationTime;}
...
protected:
	...
	// Electrically Active
	int NeuralActivatedMuscleType;
	int NeuralSensorType;
	bool IsGroundTouchSensor;
	bool IsPacemaker;
	bool IsConductive;
	float RepolarizationTime;
	float DepolarizationTime;
