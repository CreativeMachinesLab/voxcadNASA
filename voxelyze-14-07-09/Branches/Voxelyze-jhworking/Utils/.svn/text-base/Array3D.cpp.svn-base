...
////}
//
////CArray3D::CArray3D(int x, int y, int z)
////{
////	pData = NULL; //dynamic array
////	IniSpace(x, y, z);
////}
...
////}
//
//CArray3D::CArray3D(const CArray3D& rArray) //copy constructor
//{
//	XSize = rArray.XSize;
//	YSize = rArray.YSize;
//	ZSize = rArray.ZSize;
...
//}
//
//CArray3D& CArray3D::operator=(const CArray3D& rArray) //overload "=" 
//{
//	DeleteSpace();
//
//	XSize = rArray.XSize;
...
////}
//
//void CArray3D::WriteXML(CXML_Rip* pXML)
//{
...
//}
//
//void CArray3D::ReadXML(CXML_Rip* pXML)
//{
...
//
//
//void CArray3D::IniSpace(int x, int y, int z, float IniVal)
//{
//	if (pData != NULL)
//		DeleteSpace();
//
...
//}
//
//void CArray3D::ResetSpace(float IniVal)
//{
//	if (pData != NULL)
//		for(int i=0; i<FullSize; i++)
//			pData[i] = IniVal;
...
//}
//
//void CArray3D::DeleteSpace()
//{
//	if (pData != NULL) delete[] pData;
//	pData = NULL;
//}
//
//float CArray3D::GetMaxValue() //returns the maximum value anywhere in the array.
//{
//	float MaxVal = -9e9f;
...
//
////Index calculating!
//int CArray3D::GetIndex(int x, int y, int z) //returns the index in the frequency space or -1 if invalid
//{
...
//}
//
//bool CArray3D::GetXYZ(int* x, int* y, int* z, int Index) //returns the index in the frequency space or -1 if invalid
//{
