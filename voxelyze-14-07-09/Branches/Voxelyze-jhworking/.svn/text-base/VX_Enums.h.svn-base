...
inline bool isNegative(linkDirection direction) {return (bool)(direction%2);}
inline bool isPositive(linkDirection direction) {return !isNegative(direction);}
...
inline bool dofIsSet(dofObject obj, dofComponent dof){return dof&obj;}
